...
class PostManagementController extends Controller
{
    ...
    {
        $posts = Post::leftjoin('users','users.id', 'posts.posted_by_id')
    ...
    //    Post::create([Auth::user()->id],$request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        //    $post->save();
        //    return redirect()->route('postmanagement.index')->with('success','post updated successfully');
    }
